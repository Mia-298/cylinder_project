...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('spatial_filter_diff_threshold', default_value='160'),
        DeclareLaunchArgument('spatial_filter_magnitude', default_value='2'),
        DeclareLaunchArgument('spatial_filter_radius', default_value='2'),
        ...
        DeclareLaunchArgument('depth_precision', default_value=''),
        DeclareLaunchArgument('device_preset', default_value='High Density'),
