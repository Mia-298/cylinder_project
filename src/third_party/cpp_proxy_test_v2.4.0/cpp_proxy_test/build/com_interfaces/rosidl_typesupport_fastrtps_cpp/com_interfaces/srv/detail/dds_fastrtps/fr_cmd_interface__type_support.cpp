...
#include "com_interfaces/srv/detail/fr_cmd_interface__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const com_interfaces::srv::FrCmdInterface_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  com_interfaces::srv::FrCmdInterface_Request & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.pos_gain[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_com_interfaces
max_serialized_size_FrCmdInterface_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces::srv::FrCmdInterface_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const com_interfaces::srv::FrCmdInterface_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<com_interfaces::srv::FrCmdInterface_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FrCmdInterface_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const com_interfaces::srv::FrCmdInterface_Request *>(
...
static size_t _FrCmdInterface_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FrCmdInterface_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FrCmdInterface_Request__callbacks = {
  "com_interfaces::srv",
...
static rosidl_message_type_support_t _FrCmdInterface_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FrCmdInterface_Request__callbacks,
...
{
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, srv, FrCmdInterface_Request)() {
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface_Request__handle;
}
...
{
bool cdr_serialize(
  const com_interfaces::msg::FrRobotState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const com_interfaces::msg::ForcePayload &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  com_interfaces::msg::ForcePayload &);
size_t get_serialized_size(
  const com_interfaces::msg::ForcePayload &,
  size_t current_alignment);
size_t
max_serialized_size_ForcePayload(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_com_interfaces
cdr_serialize(
  const com_interfaces::srv::FrCmdInterface_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: err_code
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  com_interfaces::srv::FrCmdInterface_Response & ros_message)
{
  // Member: err_code
  cdr >> ros_message.err_code;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_com_interfaces
max_serialized_size_FrCmdInterface_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: pub_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        com_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_FrRobotState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: force_payload
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        com_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ForcePayload(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = com_interfaces::srv::FrCmdInterface_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const com_interfaces::srv::FrCmdInterface_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<com_interfaces::srv::FrCmdInterface_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FrCmdInterface_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const com_interfaces::srv::FrCmdInterface_Response *>(
...
static size_t _FrCmdInterface_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FrCmdInterface_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FrCmdInterface_Response__callbacks = {
  "com_interfaces::srv",
...
static rosidl_message_type_support_t _FrCmdInterface_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FrCmdInterface_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, srv, FrCmdInterface_Response)() {
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface_Response__handle;
}
...
static service_type_support_callbacks_t _FrCmdInterface__callbacks = {
  "com_interfaces::srv",
  "FrCmdInterface",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, srv, FrCmdInterface_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, srv, FrCmdInterface_Response)(),
...
static rosidl_service_type_support_t _FrCmdInterface__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FrCmdInterface__callbacks,
...
{
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, srv, FrCmdInterface)() {
  return &com_interfaces::srv::typesupport_fastrtps_cpp::_FrCmdInterface__handle;
}
