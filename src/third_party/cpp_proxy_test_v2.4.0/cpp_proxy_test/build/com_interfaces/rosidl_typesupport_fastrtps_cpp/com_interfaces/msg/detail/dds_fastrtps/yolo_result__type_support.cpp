...
#include "com_interfaces/msg/detail/yolo_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces::msg::YoloResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const com_interfaces::msg::YoloResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<com_interfaces::msg::YoloResult *>(
    untyped_ros_message);
...
{
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_YoloResult__handle;
}
