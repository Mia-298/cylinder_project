...
#include "com_interfaces/msg/detail/virt_agv_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const com_interfaces::msg::VirtAgvState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  com_interfaces::msg::VirtAgvState & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_com_interfaces
max_serialized_size_VirtAgvState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces::msg::VirtAgvState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const com_interfaces::msg::VirtAgvState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<com_interfaces::msg::VirtAgvState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VirtAgvState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const com_interfaces::msg::VirtAgvState *>(
...
static size_t _VirtAgvState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VirtAgvState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VirtAgvState__callbacks = {
  "com_interfaces::msg",
  "VirtAgvState",
...
static rosidl_message_type_support_t _VirtAgvState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VirtAgvState__callbacks,
...
{
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_VirtAgvState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, msg, VirtAgvState)() {
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_VirtAgvState__handle;
}
