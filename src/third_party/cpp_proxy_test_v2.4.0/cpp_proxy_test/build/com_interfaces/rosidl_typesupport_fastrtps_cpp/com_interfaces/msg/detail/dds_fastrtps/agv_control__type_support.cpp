...
#include "com_interfaces/msg/detail/agv_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const com_interfaces::msg::AgvControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  com_interfaces::msg::AgvControl & ros_message)
{
  // Member: locked
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces::msg::AgvControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const com_interfaces::msg::AgvControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<com_interfaces::msg::AgvControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AgvControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const com_interfaces::msg::AgvControl *>(
...
static size_t _AgvControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AgvControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AgvControl__callbacks = {
  "com_interfaces::msg",
  "AgvControl",
...
static rosidl_message_type_support_t _AgvControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AgvControl__callbacks,
...
{
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_AgvControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, msg, AgvControl)() {
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_AgvControl__handle;
}
