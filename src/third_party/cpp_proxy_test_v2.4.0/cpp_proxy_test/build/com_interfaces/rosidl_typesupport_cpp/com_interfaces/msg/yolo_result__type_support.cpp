...
static const _YoloResult_type_support_symbol_names_t _YoloResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, msg, YoloResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, com_interfaces, msg, YoloResult)),
  }
};
...
get_message_type_support_handle<com_interfaces::msg::YoloResult>()
{
  return &::com_interfaces::msg::rosidl_typesupport_cpp::YoloResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, com_interfaces, msg, YoloResult)() {
  return get_message_type_support_handle<com_interfaces::msg::YoloResult>();
}
