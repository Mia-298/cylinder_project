...
static const _AgvOrderState_type_support_symbol_names_t _AgvOrderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, com_interfaces, msg, AgvOrderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, com_interfaces, msg, AgvOrderState)),
  }
};
...
{
  return &::com_interfaces::msg::rosidl_typesupport_cpp::AgvOrderState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, com_interfaces, msg, AgvOrderState)() {
  return get_message_type_support_handle<com_interfaces::msg::AgvOrderState>();
}
