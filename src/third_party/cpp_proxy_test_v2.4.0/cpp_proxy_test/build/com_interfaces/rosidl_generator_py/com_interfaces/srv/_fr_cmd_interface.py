...
class Metaclass_FrCmdInterface_Request(type):
    """Metaclass of message 'FrCmdInterface_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'com_interfaces.srv.FrCmdInterface_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fr_cmd_interface__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fr_cmd_interface__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fr_cmd_interface__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fr_cmd_interface__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fr_cmd_interface__request
...
class FrCmdInterface_Request(metaclass=Metaclass_FrCmdInterface_Request):
    """Message class 'FrCmdInterface_Request'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.cmd_t = kwargs.get('cmd_t', float())
        if 'pos_gain' not in kwargs:
            self.pos_gain = numpy.zeros(6, dtype=numpy.float32)
        else:
            self.pos_gain = kwargs.get('pos_gain')
    ...
    def __eq__(self, other):
        ...
        if self.gripper_block != other.gripper_block:
            return False
        if self.cmd_t != other.cmd_t:
            return False
        if any(self.pos_gain != other.pos_gain):
            return False
        return True
    ...
    @cmd_t.setter
    def cmd_t(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cmd_t' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cmd_t' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._cmd_t = value

    @builtins.property
    def pos_gain(self):
        """Message field 'pos_gain'."""
        return self._pos_gain

    @pos_gain.setter
    def pos_gain(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float32, \
                "The 'pos_gain' numpy.ndarray() must have the dtype of 'numpy.float32'"
            assert value.size == 6, \
                "The 'pos_gain' numpy.ndarray() must have a size of 6"
            self._pos_gain = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ...
                "The 'pos_gain' field must be a set or sequence with length 6 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._pos_gain = numpy.array(value, dtype=numpy.float32)
...
class Metaclass_FrCmdInterface_Response(type):
    """Metaclass of message 'FrCmdInterface_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com_interfaces.srv.FrCmdInterface_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fr_cmd_interface__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fr_cmd_interface__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fr_cmd_interface__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fr_cmd_interface__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fr_cmd_interface__response

            from com_interfaces.msg import ForcePayload
            if ForcePayload.__class__._TYPE_SUPPORT is None:
                ForcePayload.__class__.__import_type_support__()
            ...
            from com_interfaces.msg import FrRobotState
            if FrRobotState.__class__._TYPE_SUPPORT is None:
                FrRobotState.__class__.__import_type_support__()
...
class FrCmdInterface_Response(metaclass=Metaclass_FrCmdInterface_Response):
    """Message class 'FrCmdInterface_Response'."""
    ...
    _fields_and_field_types = {
        'err_code': 'int32',
        'msg': 'string',
        'pub_state': 'com_interfaces/FrRobotState',
        'register_val': 'double',
        'io_val': 'boolean',
        'jt_pos': 'double[6]',
        'tl_pos': 'double[6]',
        'ft': 'com_interfaces/ForceTorque',
        'force_payload': 'com_interfaces/ForcePayload',
        'motion_done': 'boolean',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com_interfaces', 'msg'], 'FrRobotState'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('double'), 6),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('double'), 6),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com_interfaces', 'msg'], 'ForceTorque'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['com_interfaces', 'msg'], 'ForcePayload'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from com_interfaces.msg import FrRobotState
        self.pub_state = kwargs.get('pub_state', FrRobotState())
        ...
        from com_interfaces.msg import ForcePayload
        self.force_payload = kwargs.get('force_payload', ForcePayload())
        self.motion_done = kwargs.get('motion_done', bool())
    ...
    def __eq__(self, other):
        ...
        if self.ft != other.ft:
            return False
        if self.force_payload != other.force_payload:
            return False
    ...
    def pub_state(self, value):
        if __debug__:
            from com_interfaces.msg import FrRobotState
            assert \
                isinstance(value, FrRobotState), \
                "The 'pub_state' field must be a sub message of type 'FrRobotState'"
    ...
    @builtins.property
    def force_payload(self):
        """Message field 'force_payload'."""
        return self._force_payload

    @force_payload.setter
    def force_payload(self, value):
        if __debug__:
            from com_interfaces.msg import ForcePayload
            assert \
                isinstance(value, ForcePayload), \
                "The 'force_payload' field must be a sub message of type 'ForcePayload'"
        self._force_payload = value
    ...
    def motion_done(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'motion_done' field must be of type 'bool'"
        self._motion_done = value


class Metaclass_FrCmdInterface(type):
    """Metaclass of service 'FrCmdInterface'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'com_interfaces.srv.FrCmdInterface')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__fr_cmd_interface

            from com_interfaces.srv import _fr_cmd_interface
            if _fr_cmd_interface.Metaclass_FrCmdInterface_Request._TYPE_SUPPORT is None:
                _fr_cmd_interface.Metaclass_FrCmdInterface_Request.__import_type_support__()
            if _fr_cmd_interface.Metaclass_FrCmdInterface_Response._TYPE_SUPPORT is None:
                _fr_cmd_interface.Metaclass_FrCmdInterface_Response.__import_type_support__()


class FrCmdInterface(metaclass=Metaclass_FrCmdInterface):
    from com_interfaces.srv._fr_cmd_interface import FrCmdInterface_Request as Request
    from com_interfaces.srv._fr_cmd_interface import FrCmdInterface_Response as Response
