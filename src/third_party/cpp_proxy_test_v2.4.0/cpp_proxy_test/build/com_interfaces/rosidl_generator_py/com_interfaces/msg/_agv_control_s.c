...
bool com_interfaces__msg__agv_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.msg._agv_control.AgvControl", full_classname_dest, 42) == 0);
  }
  com_interfaces__msg__AgvControl * ros_message = _ros_message;
  {  // locked
...
{
  /* NOTE(esteve): Call constructor of AgvControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.msg._agv_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgvControl");
