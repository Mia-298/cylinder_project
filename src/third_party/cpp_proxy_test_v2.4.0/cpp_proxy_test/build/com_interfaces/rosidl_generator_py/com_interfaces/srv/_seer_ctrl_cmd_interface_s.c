...
bool com_interfaces__srv__seer_ctrl_cmd_interface__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.srv._seer_ctrl_cmd_interface.SeerCtrlCmdInterface_Request", full_classname_dest, 72) == 0);
  }
  com_interfaces__srv__SeerCtrlCmdInterface_Request * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of SeerCtrlCmdInterface_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.srv._seer_ctrl_cmd_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SeerCtrlCmdInterface_Request");
...
bool com_interfaces__msg__agv_loc__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
ROSIDL_GENERATOR_C_EXPORT
bool com_interfaces__srv__seer_ctrl_cmd_interface__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.srv._seer_ctrl_cmd_interface.SeerCtrlCmdInterface_Response", full_classname_dest, 73) == 0);
  }
  com_interfaces__srv__SeerCtrlCmdInterface_Response * ros_message = _ros_message;
  {  // err_code
  ...
  {  // loc
    PyObject * field = PyObject_GetAttrString(_pymsg, "loc");
    if (!field) {
      return false;
    }
    if (!com_interfaces__msg__agv_loc__convert_from_py(field, &ros_message->loc)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SeerCtrlCmdInterface_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.srv._seer_ctrl_cmd_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SeerCtrlCmdInterface_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // loc
    PyObject * field = NULL;
    field = com_interfaces__msg__agv_loc__convert_to_py(&ros_message->loc);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "loc", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
