...
bool com_interfaces__msg__seer_m4_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.msg._seer_m4_state.SeerM4State", full_classname_dest, 45) == 0);
  }
  com_interfaces__msg__SeerM4State * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of SeerM4State */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.msg._seer_m4_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SeerM4State");
