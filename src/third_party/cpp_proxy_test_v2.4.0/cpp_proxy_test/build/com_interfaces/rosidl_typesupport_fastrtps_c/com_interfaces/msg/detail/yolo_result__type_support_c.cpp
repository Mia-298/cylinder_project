...
#include "com_interfaces/msg/detail/yolo_result__rosidl_typesupport_fastrtps_c.h"
...
using _YoloResult__ros_msg_type = com_interfaces__msg__YoloResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _YoloResult__ros_msg_type * ros_message = static_cast<const _YoloResult__ros_msg_type *>(untyped_ros_message);
  // Field name: class_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _YoloResult__ros_msg_type * ros_message = static_cast<_YoloResult__ros_msg_type *>(untyped_ros_message);
  // Field name: class_id
  {
    cdr >> ros_message->class_id;
  }
...
static uint32_t _YoloResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_com_interfaces__msg__YoloResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces__msg__YoloResult;
    is_plain =
      (
...
static size_t _YoloResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_com_interfaces__msg__YoloResult(
...
static message_type_support_callbacks_t __callbacks_YoloResult = {
  "com_interfaces::msg",
  "YoloResult",
...
static rosidl_message_type_support_t _YoloResult__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_YoloResult,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, msg, YoloResult)() {
  return &_YoloResult__type_support;
}
