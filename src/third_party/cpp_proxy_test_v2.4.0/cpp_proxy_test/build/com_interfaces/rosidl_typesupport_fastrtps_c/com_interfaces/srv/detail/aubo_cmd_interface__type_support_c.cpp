...
#include "com_interfaces/srv/detail/aubo_cmd_interface__rosidl_typesupport_fastrtps_c.h"
...
using _AuboCmdInterface_Request__ros_msg_type = com_interfaces__srv__AuboCmdInterface_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AuboCmdInterface_Request__ros_msg_type * ros_message = static_cast<const _AuboCmdInterface_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _AuboCmdInterface_Request__ros_msg_type * ros_message = static_cast<_AuboCmdInterface_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
size_t get_serialized_size_com_interfaces__srv__AuboCmdInterface_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AuboCmdInterface_Request__ros_msg_type * ros_message = static_cast<const _AuboCmdInterface_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AuboCmdInterface_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_com_interfaces__srv__AuboCmdInterface_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_com_interfaces
size_t max_serialized_size_com_interfaces__srv__AuboCmdInterface_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = com_interfaces__srv__AuboCmdInterface_Request;
    is_plain =
      (
...
static size_t _AuboCmdInterface_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_com_interfaces__srv__AuboCmdInterface_Request(
...
static message_type_support_callbacks_t __callbacks_AuboCmdInterface_Request = {
  "com_interfaces::srv",
...
static rosidl_message_type_support_t _AuboCmdInterface_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AuboCmdInterface_Request,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, AuboCmdInterface_Request)() {
  return &_AuboCmdInterface_Request__type_support;
}
...
#include "com_interfaces/msg/detail/aubo_robot_state__functions.h"  // pub_state
...
using _AuboCmdInterface_Response__ros_msg_type = com_interfaces__srv__AuboCmdInterface_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AuboCmdInterface_Response__ros_msg_type * ros_message = static_cast<const _AuboCmdInterface_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: err_code
  {
  ...
  // Field name: pub_state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, com_interfaces, msg, AuboRobotState
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _AuboCmdInterface_Response__ros_msg_type * ros_message = static_cast<_AuboCmdInterface_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: err_code
  {
    cdr >> ros_message->err_code;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_com_interfaces
size_t get_serialized_size_com_interfaces__srv__AuboCmdInterface_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AuboCmdInterface_Response__ros_msg_type * ros_message = static_cast<const _AuboCmdInterface_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_com_interfaces__msg__AuboRobotState(
...
static uint32_t _AuboCmdInterface_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_com_interfaces__srv__AuboCmdInterface_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_com_interfaces
size_t max_serialized_size_com_interfaces__srv__AuboCmdInterface_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: pub_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_com_interfaces__msg__AuboRobotState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = com_interfaces__srv__AuboCmdInterface_Response;
    is_plain =
      (
...
static size_t _AuboCmdInterface_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_com_interfaces__srv__AuboCmdInterface_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_AuboCmdInterface_Response = {
  "com_interfaces::srv",
...
static rosidl_message_type_support_t _AuboCmdInterface_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AuboCmdInterface_Response,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, AuboCmdInterface_Response)() {
  return &_AuboCmdInterface_Response__type_support;
}
...
// already included above
// #include "com_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "com_interfaces/srv/aubo_cmd_interface.h"
...
static service_type_support_callbacks_t AuboCmdInterface__callbacks = {
  "com_interfaces::srv",
  "AuboCmdInterface",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, AuboCmdInterface_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, AuboCmdInterface_Response)(),
...
static rosidl_service_type_support_t AuboCmdInterface__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &AuboCmdInterface__callbacks,
  get_service_typesupport_handle_function,
};

const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, AuboCmdInterface)() {
  return &AuboCmdInterface__handle;
}
