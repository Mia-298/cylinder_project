...
static const _RmCeuCmdInterface_Request_type_support_symbol_names_t _RmCeuCmdInterface_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, RmCeuCmdInterface_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, com_interfaces, srv, RmCeuCmdInterface_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, com_interfaces, srv, RmCeuCmdInterface_Request)() {
  return &::com_interfaces::srv::rosidl_typesupport_c::RmCeuCmdInterface_Request_message_type_support_handle;
}
...
static const _RmCeuCmdInterface_Response_type_support_symbol_names_t _RmCeuCmdInterface_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, RmCeuCmdInterface_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, com_interfaces, srv, RmCeuCmdInterface_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, com_interfaces, srv, RmCeuCmdInterface_Response)() {
  return &::com_interfaces::srv::rosidl_typesupport_c::RmCeuCmdInterface_Response_message_type_support_handle;
}
...
static const _RmCeuCmdInterface_type_support_symbol_names_t _RmCeuCmdInterface_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, com_interfaces, srv, RmCeuCmdInterface)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, com_interfaces, srv, RmCeuCmdInterface)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, com_interfaces, srv, RmCeuCmdInterface)() {
  return &::com_interfaces::srv::rosidl_typesupport_c::RmCeuCmdInterface_service_type_support_handle;
}
