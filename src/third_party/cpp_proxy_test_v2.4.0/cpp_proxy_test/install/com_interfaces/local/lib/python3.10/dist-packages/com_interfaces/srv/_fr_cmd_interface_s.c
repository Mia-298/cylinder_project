...
bool com_interfaces__srv__fr_cmd_interface__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.srv._fr_cmd_interface.FrCmdInterface_Request", full_classname_dest, 59) == 0);
  }
  com_interfaces__srv__FrCmdInterface_Request * ros_message = _ros_message;
  {  // id
  ...
  {  // cmd_t
    PyObject * field = PyObject_GetAttrString(_pymsg, "cmd_t");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->cmd_t = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // pos_gain
    PyObject * field = PyObject_GetAttrString(_pymsg, "pos_gain");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 6;
      float * dest = ros_message->pos_gain;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of FrCmdInterface_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.srv._fr_cmd_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FrCmdInterface_Request");
  ...
  {  // cmd_t
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->cmd_t);
    {
      int rc = PyObject_SetAttrString(_pymessage, "cmd_t", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // pos_gain
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "pos_gain");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    float * src = &(ros_message->pos_gain[0]);
...
bool com_interfaces__msg__force_payload__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * com_interfaces__msg__force_payload__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool com_interfaces__srv__fr_cmd_interface__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.srv._fr_cmd_interface.FrCmdInterface_Response", full_classname_dest, 60) == 0);
  }
  com_interfaces__srv__FrCmdInterface_Response * ros_message = _ros_message;
  {  // err_code
  ...
  {  // pub_state
    ...
    if (!com_interfaces__msg__fr_robot_state__convert_from_py(field, &ros_message->pub_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // force_payload
    PyObject * field = PyObject_GetAttrString(_pymsg, "force_payload");
    if (!field) {
      return false;
    }
    if (!com_interfaces__msg__force_payload__convert_from_py(field, &ros_message->force_payload)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // motion_done
    ...
    assert(PyBool_Check(field));
    ros_message->motion_done = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of FrCmdInterface_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.srv._fr_cmd_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FrCmdInterface_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // pub_state
    PyObject * field = NULL;
    field = com_interfaces__msg__fr_robot_state__convert_to_py(&ros_message->pub_state);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // force_payload
    PyObject * field = NULL;
    field = com_interfaces__msg__force_payload__convert_to_py(&ros_message->force_payload);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "force_payload", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // motion_done
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->motion_done ? 1 : 0);
    {
