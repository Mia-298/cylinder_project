...
bool com_interfaces__msg__yolo_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.msg._yolo_result.YoloResult", full_classname_dest, 42) == 0);
  }
  com_interfaces__msg__YoloResult * ros_message = _ros_message;
  {  // class_id
...
PyObject * com_interfaces__msg__yolo_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.msg._yolo_result");
