...
bool com_interfaces__msg__agv_guide_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("com_interfaces.msg._agv_guide_state.AgvGuideState", full_classname_dest, 49) == 0);
  }
  com_interfaces__msg__AgvGuideState * ros_message = _ros_message;
  {  // task_status
...
{
  /* NOTE(esteve): Call constructor of AgvGuideState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("com_interfaces.msg._agv_guide_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgvGuideState");
