...
#ifndef COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__FUNCTIONS_H_
#define COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__FUNCTIONS_H_
...
/// Initialize srv/AuboCmdInterface message.
/**
...
/// Finalize srv/AuboCmdInterface message.
/**
...
/// Create srv/AuboCmdInterface message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * com_interfaces__srv__AuboCmdInterface_Request__init().
...
/// Destroy srv/AuboCmdInterface message.
/**
 * It calls
 * com_interfaces__srv__AuboCmdInterface_Request__fini()
...
/// Check for srv/AuboCmdInterface message equality.
/**
...
/// Copy a srv/AuboCmdInterface message.
/**
...
/// Initialize array of srv/AuboCmdInterface messages.
/**
...
/// Finalize array of srv/AuboCmdInterface messages.
/**
 * It calls
 * com_interfaces__srv__AuboCmdInterface_Request__fini()
...
/// Create array of srv/AuboCmdInterface messages.
/**
 * It allocates the memory for the array and calls
 * com_interfaces__srv__AuboCmdInterface_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AuboCmdInterface messages.
/**
 * It calls
 * com_interfaces__srv__AuboCmdInterface_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AuboCmdInterface message array equality.
/**
...
/// Copy an array of srv/AuboCmdInterface messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * com_interfaces__srv__AuboCmdInterface_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It calls
 * com_interfaces__srv__AuboCmdInterface_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It allocates the memory for the array and calls
 * com_interfaces__srv__AuboCmdInterface_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It calls
 * com_interfaces__srv__AuboCmdInterface_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__FUNCTIONS_H_
