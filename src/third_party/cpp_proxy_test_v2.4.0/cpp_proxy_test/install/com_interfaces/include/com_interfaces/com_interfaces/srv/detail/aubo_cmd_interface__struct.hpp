...
#ifndef COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__STRUCT_HPP_
#define COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__com_interfaces__srv__AuboCmdInterface_Request __attribute__((deprecated))
#else
# define DEPRECATED__com_interfaces__srv__AuboCmdInterface_Request __declspec(deprecated)
#endif
...
struct AuboCmdInterface_Request_
{
  using Type = AuboCmdInterface_Request_<ContainerAllocator>;

  explicit AuboCmdInterface_Request_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit AuboCmdInterface_Request_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : position(_alloc),
    program(_alloc),
    filename(_alloc)
  {
  ...
  // pointer types
  using RawPtr =
    com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__com_interfaces__srv__AuboCmdInterface_Request
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__com_interfaces__srv__AuboCmdInterface_Request
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Request_<ContainerAllocator> const>
  ...
  bool operator==(const AuboCmdInterface_Request_ & other) const
  {
    if (this->id != other.id) {
      return false;
    }
...
using AuboCmdInterface_Request =
  com_interfaces::srv::AuboCmdInterface_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__com_interfaces__srv__AuboCmdInterface_Response __attribute__((deprecated))
#else
# define DEPRECATED__com_interfaces__srv__AuboCmdInterface_Response __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct AuboCmdInterface_Response_
{
  using Type = AuboCmdInterface_Response_<ContainerAllocator>;

  explicit AuboCmdInterface_Response_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : pub_state(_init),
    ft(_init)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
  ...
  explicit AuboCmdInterface_Response_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : msg(_alloc),
  ...
  Type & set__pub_state(
    const com_interfaces::msg::AuboRobotState_<ContainerAllocator> & _arg)
  {
    this->pub_state = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__com_interfaces__srv__AuboCmdInterface_Response
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__com_interfaces__srv__AuboCmdInterface_Response
    std::shared_ptr<com_interfaces::srv::AuboCmdInterface_Response_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const AuboCmdInterface_Response_ & other) const
  {
...
// alias to use template instance with default allocator
using AuboCmdInterface_Response =
  com_interfaces::srv::AuboCmdInterface_Response_<std::allocator<void>>;
...
struct AuboCmdInterface
{
  using Request = com_interfaces::srv::AuboCmdInterface_Request;
  using Response = com_interfaces::srv::AuboCmdInterface_Response;
};
...
#endif  // COM_INTERFACES__SRV__DETAIL__AUBO_CMD_INTERFACE__STRUCT_HPP_
