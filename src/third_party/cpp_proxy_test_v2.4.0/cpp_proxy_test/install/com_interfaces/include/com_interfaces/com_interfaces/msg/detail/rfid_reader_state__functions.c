...
com_interfaces__msg__RfidReaderState__init(com_interfaces__msg__RfidReaderState * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    com_interfaces__msg__RfidReaderState__fini(msg);
    return false;
  }
  // err_code
  // err_msg
...
com_interfaces__msg__RfidReaderState__create()
{
  ...
  com_interfaces__msg__RfidReaderState * msg = (com_interfaces__msg__RfidReaderState *)allocator.allocate(sizeof(com_interfaces__msg__RfidReaderState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(com_interfaces__msg__RfidReaderState));
  bool success = com_interfaces__msg__RfidReaderState__init(msg);
  if (!success) {
...
com_interfaces__msg__RfidReaderState__Sequence__init(com_interfaces__msg__RfidReaderState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  com_interfaces__msg__RfidReaderState * data = NULL;

  if (size) {
    data = (com_interfaces__msg__RfidReaderState *)allocator.zero_allocate(size, sizeof(com_interfaces__msg__RfidReaderState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = com_interfaces__msg__RfidReaderState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        com_interfaces__msg__RfidReaderState__fini(&data[i - 1]);
      }
...
com_interfaces__msg__RfidReaderState__Sequence__fini(com_interfaces__msg__RfidReaderState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      com_interfaces__msg__RfidReaderState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  com_interfaces__msg__RfidReaderState__Sequence * array = (com_interfaces__msg__RfidReaderState__Sequence *)allocator.allocate(sizeof(com_interfaces__msg__RfidReaderState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = com_interfaces__msg__RfidReaderState__Sequence__init(array, size);
  if (!success) {
...
com_interfaces__msg__RfidReaderState__Sequence__destroy(com_interfaces__msg__RfidReaderState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    com_interfaces__msg__RfidReaderState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
com_interfaces__msg__RfidReaderState__Sequence__are_equal(const com_interfaces__msg__RfidReaderState__Sequence * lhs, const com_interfaces__msg__RfidReaderState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!com_interfaces__msg__RfidReaderState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  com_interfaces__msg__RfidReaderState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(com_interfaces__msg__RfidReaderState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    com_interfaces__msg__RfidReaderState * data =
      (com_interfaces__msg__RfidReaderState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!com_interfaces__msg__RfidReaderState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          com_interfaces__msg__RfidReaderState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!com_interfaces__msg__RfidReaderState__copy(
